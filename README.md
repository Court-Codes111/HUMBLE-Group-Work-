...
🛒 Shopping Experience
Product catalog with mystery boxes
Add items to cart
Purchase mystery boxes to discover random items
View purchase history
Calculate totals with tax and shipping


📊 Dashboard
User statistics (gender distribution, age groups)
...
Use valid TRN (9 digits exactly)
